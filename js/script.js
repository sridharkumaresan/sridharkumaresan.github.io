...
else 
{
  ...
  if ( $(window).width() > 1023) {  
    ...
    tiles = $("h2, h3, .column-one, .column-two, .column-three, .grid li, .contact .content .form, .contact .content .contact-text, .about-us .content .content-fullwidth").fadeTo(0, 0);
